...
// ========== ЗАГРУЗКА ДАННЫХ (с таймаутами 30 с) ==========
...
// ========== СОХРАНЕНИЕ С UPSERT (с таймаутом 30 с) ==========
